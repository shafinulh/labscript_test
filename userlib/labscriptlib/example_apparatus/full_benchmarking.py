...
def analog_output_ramp():
    t=ramp_ti
    ao0_6363.constant(t=0, value=0)
    ao0_6361.constant(t=0, value=0)
    ao0_6739.constant(t=0, value=0)
    ...
    ao0_6363.constant(t=t, value=(ramp_vf/2))
    ao0_6361.constant(t=t, value=(ramp_vf/2))
    ao0_6739.constant(t=t, value=(ramp_vf/2))
    return t

def analog_output_exp_ramp():
    t=0
    ao1_6363.constant(t=t, value=exp_ramp_vi)
    ao1_6361.constant(t=t, value=exp_ramp_vi)
    ao1_6739.constant(t=t, value=exp_ramp_vi)
    t=exp_ramp_ti
    ao1_6363.sine4_reverse_ramp(
        t=t,
        initial=exp_ramp_vf,
        final=exp_ramp_vi,
...
def collect_AO_0():
    t=ramp_ti
    ai0_6363.acquire(label='AO_ramp', start_time=t, end_time=exp_ramp_tf)
    t+=ai0_6361.acquire(label='AO_ramp', start_time=t, end_time=exp_ramp_tf)
    return t

def collect_AO_1():
    t=exp_ramp_ti
    ai1_6363.acquire(label='AI_signal', start_time=0, end_time=exp_ramp_tf)
